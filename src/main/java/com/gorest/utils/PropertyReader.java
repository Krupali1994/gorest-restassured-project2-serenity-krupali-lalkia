...
public class PropertyReader {
    ...
    public String getProperty(String propertyName){
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir")+"/C:\\Users\\ahirg\\IdeaProjects\\gorest-restassured-project2-serenity-krupali-lalkia\\src\\test\\resources\\propertyfile\\application.properties");
